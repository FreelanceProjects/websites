...
<div class="wrap">
	<h2><?php echo __("Расширенный экспорт/импорт");?></h2>
	<div id="poststuff">
		<div class="postbox" style="clear:both;overflow:hidden;">
			...
			<form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" >
				...
				<div style="margin:15px;">
					<input type="checkbox" name="include_cat" value="1"/> Экспортировать категории<br/>
					<input type="checkbox" name="include_tag" value="1"/> Экспортировать метки<br/><br/>
					<input type="submit" name="submit_wpshop_export" value="Экспортировать" />
				</div>
				</form>
			</div>
	</div>
	<div id="poststuff">
		<div class="postbox">
			...
			<form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" enctype="multipart/form-data">
				...
				<div class="submit"><input type="submit" name="submit_wpshop_import" value="Импортировать" /></div>
			</form>
		</div>
	</div>
</div>